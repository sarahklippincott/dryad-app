...
import * as frictionlessComponents from 'frictionless-components';
        ...
        if (urlsObject['url'].length) {
            ...
            axios.post(`/stash/${typeFilePartialRoute}/validate_urls/${this.props.resource_id}`, urlsObject)
                .then(response => {
                    ...
                    const testReport = document.getElementById('test_report');
                    frictionlessComponents.render(frictionlessComponents.Report, ReportTest, testReport);
                })
